...
public class AppUserDAOImplTest {
    ...
    public void createSqlString(){
        ...
        String sql2 = AppUserDAOImpl.getSQlString(10,"AA",1,"companyName");
        //then
        ...
        Assert.assertEquals("SELECT * FROM appUser a LEFT JOIN company b on a.company_id=b.company_id "+
                "WHERE (lastName LIKE '%AA%' OR firstName LIKE '%AA%')  AND company_id ==1 LIMIT 10 OFFSET 10 ORDER BY companyName",sql2);
    }
